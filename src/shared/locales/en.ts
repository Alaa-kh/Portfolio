...
export const en: TranslationDictionary = {
  ...
  services: {
    ...
    description:
      'Practical engineering support for product teams and founders who need reliable delivery.',
  },
  contact: {
    eyebrow: 'Contact',
  ...
  footer: {
    description:
      'Software developer building modern web and mobile experiences with clean architecture.',
